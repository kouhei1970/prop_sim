...
Lv0   測位率 100.0%  RMSE3D  0.606  RMSE2D  0.330  CEP50  0.140  CEP95  0.641  最大  2.862  [m]
Lv1   測位率 100.0%  RMSE3D  0.321  RMSE2D  0.155  CEP50  0.086  CEP95  0.256  最大  2.075  [m]
Lv2   測位率 100.0%  RMSE3D  0.280  RMSE2D  0.125  CEP50  0.079  CEP95  0.185  最大  2.299  [m]
Lv3   測位率 100.0%  RMSE3D  0.126  RMSE2D  0.075  CEP50  0.055  CEP95  0.139  最大  0.394  [m]
```
...
空力モデルの Lv0〜Lv3 と同じ考え方で、**同一インターフェイスで差し替えられる**測位器を
4 段階そろえてある。呼び出し側のコードはレベルが変わっても 1 行も変わらない。
