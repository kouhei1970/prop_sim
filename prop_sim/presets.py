...
#: (gray < 95 かつ sat < 70). 明度だけで切ると前縁下面に落ちた影 (暗い赤)
#: まで拾ってしまい, 下面が実際より 2-3 %c 下側に膨らむ — 影は暗くても
#: 彩度が高いので, 2 条件で分離できる (閾値は実物と見比べて選定).
#: そのうえで最遠点対を前縁-後縁としてコード系に回転し, コード方向
#: 100 分割の上下面からキャンバ線と厚み分布を求めて多項式で平滑化した.
_STAMPFLY_1209_SECTION = np.array([
    #  x/c     z/c      t/c
    [0.0000, 0.00000, 0.00400],
    [0.0125, 0.00489, 0.03888],
    [0.0250, 0.00946, 0.05320],
    [0.0500, 0.01772, 0.07039],
    [0.0750, 0.02492, 0.08064],
    [0.1000, 0.03122, 0.08709],
    [0.1500, 0.04159, 0.09339],
    [0.2000, 0.04963, 0.09461],
    [0.2500, 0.05594, 0.09318],
    [0.3000, 0.06094, 0.09042],
    [0.3500, 0.06486, 0.08717],
    [0.4000, 0.06783, 0.08390],
    [0.4500, 0.06984, 0.08089],
    [0.5000, 0.07084, 0.07821],
    [0.5500, 0.07070, 0.07579],
    [0.6000, 0.06926, 0.07345],
    [0.6500, 0.06637, 0.07089],
    [0.7000, 0.06189, 0.06769],
    [0.7500, 0.05570, 0.06333],
    [0.8000, 0.04774, 0.05723],
    [0.8500, 0.03803, 0.04868],
    [0.9000, 0.02668, 0.03688],
    [0.9500, 0.01390, 0.02098],
    [1.0000, 0.00000, 0.01800],
])
...
STAMPFLY_1209_MEASURED = {
    ...
    "section_thickness_max": 0.095,     # t/c
    "section_thickness_max_x": 0.20,
    "section_camber_max": 0.071,        # f/c
    "section_camber_max_x": 0.50,
    "section_alpha0_deg_inviscid": -8.33,   # 薄翼理論
    "section_cl_ideal": 0.976,
    "section_cm_ac": -0.224,
